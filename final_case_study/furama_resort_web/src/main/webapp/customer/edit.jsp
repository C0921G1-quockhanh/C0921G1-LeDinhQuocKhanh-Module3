                        ...
                        <form method="post">
                            <div>
                                <c:if test="${existingCustomer != null}">
                                    <input type="hidden" name="customerID" value="<c:out value="${existingCustomer.customerID}"/>">
                                </c:if>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="customerName" name="customerName" value="<c:out value="${existingCustomer.customerName}"/>">
                            </div>

                            <div class="mb-3">
                                <label for="dateOfBirth" class="form-label">Date Of Birth: </label>
                                <input type="text" class="form-control" id="dateOfBirth" name="dateOfBirth" value="<c:out value="${existingCustomer.dateOfBirth}"/>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="identityNumber" name="identityNumber" value="<c:out value="${existingCustomer.identityNumber}"/>">
                            </div>

                            <div class="mb-3">
                                <label for="phoneNumber" class="form-label">Phone Number: </label>
                                <input type="text" class="form-control" id="phoneNumber" name="phoneNumber" value="<c:out value="${existingCustomer.phoneNumber}"/>">
                            </div>

                            <div class="mb-3">
                                <label for="email" class="form-label">Email: </label>
                                <input type="text" class="form-control" id="email" name="email" value="<c:out value="${existingCustomer.email}"/>">
                            </div>

                            <div class="mb-3">
                                <label for="address" class="form-label">Address: </label>
                                <input type="text" class="form-control" id="address" name="address" value="<c:out value="${existingCustomer.address}"/>">
                            </div>
