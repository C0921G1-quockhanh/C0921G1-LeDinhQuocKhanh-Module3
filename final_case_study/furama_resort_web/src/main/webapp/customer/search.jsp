            ...
            <div class="col-xl-11">
                    ...
                    <div class="col-xl-12">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th scope="col">Customer_Type_Name</th>
                            ...
                            <tbody>
                                <c:forEach var="customer" items="${customers}">
                                    <tr>
                                        ...
                                        <td>
                                            <c:out value="${customer.customerType.customerTypeID}"/>
                                        </td>

                                        <td>
                                            <c:out value="${customer.customerType.customerTypeName}"/>
                                        </td>
                                        ...
                                        <td>
                                            <c:out value="${customer.identityNumber}"/>
                                        </td>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <a href="/employees" class="ms-1 text-decoration-none text-dark">Back to customer list!</a>
                    </div>
                </div>
            </div>
        </div>
