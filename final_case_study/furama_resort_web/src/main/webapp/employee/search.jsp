                        ...
                        <table class="table">
                            ...
                            <c:forEach var="employee" items="${employees}">
                                <tr>
                                    ...
                                    <td>
                                        <c:out value="${employee.identityNumber}"/>
                                    </td>
                                    ...
                                    <td>
                                        <c:out value="${employee.position.positionName}"/>
                                    </td>

                                    <td>
                                        <c:out value="${employee.qualification.qualificationName}"/>
                                    </td>
                                    ...
                                    <td>
                                        <a href="/employees?action=edit&id=${employee.employeeID}" class="text-dark text-decoration-none">Edit</a>
                                    </td>
