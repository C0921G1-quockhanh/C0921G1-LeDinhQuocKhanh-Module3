                    ...
                    <div class="col-xl-12">
                        <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="default select example" id="customerID" name="customerID">
                                    <option></option>
                            ...
                            <button type="submit" class="btn btn-secondary">Add New Contract</button>
