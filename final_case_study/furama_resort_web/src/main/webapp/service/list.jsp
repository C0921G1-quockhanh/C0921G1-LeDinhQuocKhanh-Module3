    ...
    <div class="container-fluid mt-3" style="height: 600px">
        <div class="row h-100">
            ...
            <div class="col-xl-11">
                <div class="row">
                    <div class="col-xl-12">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-boombox-fill ms-3" viewBox="0 0 16 16">
                        ...
                        <a href="/services?action=create" class="text-dark text-decoration-none fw-bold ms-2">Add new service? Click here!</a>
                    </div>
                </div>
            </div>
        </div>
