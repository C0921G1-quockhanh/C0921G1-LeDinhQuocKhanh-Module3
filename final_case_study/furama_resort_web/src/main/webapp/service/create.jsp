                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form method="post">
                            ...
                            <div class="mb-3">
                                <label for="rentalTypeID" class="form-label">Rental Type ID: </label>
                            ...
                            <div class="mb-3">
                                <label for="roomStandard" class="form-label">Room standard: </label>
                            ...
                            <div class="mb-3">
                                <label for="extraAmenity" class="form-label">Extra Amenity: </label>
                            ...
                            <a href="/services" class="ms-1 text-decoration-none text-dark">Back to service list!</a>
