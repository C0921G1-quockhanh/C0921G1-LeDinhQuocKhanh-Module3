      ...
      <div class="container-fluid fixed-bottom">
          <div class="row">
              ...
              <div class="col-xl-6">
                  <div class="row">
                      <div class="col-xl-12">
                          <span>Want to receive exclusive hotel offers? Subscribe to our newsletter!</span>

                          <form class="d-flex">
                            <input class="form-control me-2" type="search" placeholder="Email address" aria-label="Search">
                            <button class="btn btn-outline-success text-dark" type="submit">Subscribe</button>
                          </form>
                      </div>
                  </div>
              </div>
